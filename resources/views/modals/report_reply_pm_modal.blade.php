<div class="modal fade" id="reportpmReplyModal" tabindex="-1" role="dialog" aria-labelledby="reportModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <!-- Modal content here, including radio buttons for report reasons -->
            <form action="{{ route('reports.store') }}" id="reportReplypmForm" method="POST">
                @csrf
                <input type="hidden" name="replypm_id" id="replypmIdInput" value="">
                <input type="hidden" name="conversation_id" id="conversationIdInput" value="{{ $conversation->id }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" id="otherReasonReplypmInput" style="display: none;">
                ...
                <div class="modal-footer">
                    ...
                    <button style="background-color: blue" id="submitReportpmButton" type="submit" class="btn btn-primary">Submit Report</button>
                </div>
            </form>
        </div>
    </div>
</div>
<script type="text/javascript" src="{{ URL::asset('js/otherReasonpm.js') }}"></script>
