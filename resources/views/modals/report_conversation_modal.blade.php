<div class="modal fade" id="reportConversationModal" tabindex="-1" role="dialog" aria-labelledby="reportModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <!-- Modal content here, including radio buttons for report reasons -->
            <form action="{{ route('reports.store') }}" id="conversationReportForm" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" id="otherReasonConversationInput" style="display: none;">
                ...
                <div class="modal-footer">
                    ...
                    <button id="submitconversationReportButton" style="background-color: blue" type="submit"
...
<script type="text/javascript" src="{{ URL::asset('js/otherReasonConversation.js') }}"></script>
